...
int main() {
    ...
    AudioLeft->ioa_Data = intermission_raw;
    AudioLeft->ioa_Length = intermission_raw_len;
    ...
    AudioRight->ioa_Data = intermission_raw;
    AudioRight->ioa_Length = intermission_raw_len;
