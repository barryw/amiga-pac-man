...
UWORD maze[] = {
    ...
    0 * TILE_SIZE + 4, 31 * TILE_SIZE, 28 * TILE_SIZE - 4, 31 * TILE_SIZE,
    28 * TILE_SIZE - 3, 30 * TILE_SIZE + 6, 28 * TILE_SIZE - 2, 30 * TILE_SIZE + 6,
    28 * TILE_SIZE - 1, 30 * TILE_SIZE + 5, 28 * TILE_SIZE - 1, 30 * TILE_SIZE + 4,
    28 * TILE_SIZE, 30 * TILE_SIZE + 3, 28 * TILE_SIZE, 19 * TILE_SIZE + 3,
